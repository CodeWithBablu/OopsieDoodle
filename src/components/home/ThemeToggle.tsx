...
export function ThemeToggle() {
  ...
  return (
    <button className="fixed z-40 top-0 right-[12vw] landscape:top-5 landscape:right-5 flex justify-center items-center p-2 border-gray-700 hover:bg-gray-300/40 dark:hover:bg-zinc-700/90 rounded-xl">
